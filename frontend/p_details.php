<?php
   include '../connect.php';
   $p_slug = $_GET['slug'];
   $p_sql = "SELECT * FROM products WHERE slug = '$p_slug'";
...
<html lang="en">
   ...
   <body>
      ...
      <div class="row">
                  <div class="col">
                        <img src="static/images/tshirt-img.png" alt="image" height="200px" width="200">
                  </div>
                  <div class="col">
                        <div class=""><?php echo $product['name'] ?></div>
                        <div>NPR <?php echo $product['rate'] ?></div>
                        ...
                        <div class="btn_main">
                                    <form action="manage_cart.php" method="POST"> 
                                       ...
                                       <input type="hidden" name="rate" value="<?php echo $product['rate'] ?>"><br>
