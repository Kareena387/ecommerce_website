...
$categories = $c_result->fetch_all(MYSQLI_ASSOC);

$c_mwf_sql = "SELECT P.id as p_id, P.name as p_name,P.slug as p_slug, P.rate as p_rate, P.image as p_image FROM products P INNER JOIN categories C ON  P.category = C.id WHERE C.slug = 'man_woman_fashion' ORDER BY P.id DESC LIMIT 3";
$c_mwf_result = $conn->query($c_mwf_sql);
$c_mwf_procucts = $c_mwf_result->fetch_all(MYSQLI_ASSOC);
               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="fashion_section_2">
                        <div class="row">
                            <?php foreach($c_mwf_procucts as $c_mwf_procuct){ ?>
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text"><?php echo $c_mwf_procuct['p_name'] ?></h4>
                                 <p class="price_text">Price  <span style="color: #262626;">NPR <?php echo $c_mwf_procuct['p_rate'] ?></span></p>
                                 <div class="tshirt_img"><img src="static/images/tshirt-img.png"></div>
                                 <p><a href="p_details.php?slug=<?php echo $c_mwf_procuct['p_slug'] ?>">See More</a> </p>
                              </div>
                           </div>
                           <?php } ?>
