...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
     ...
     if (empty($_POST["full_name"])) {
        ...
        $full_nameErr = "Full name must be text";
    }else{
    ...
    if($full_nameErr == "" && $emailErr == "" && $passwordErr == "" && $imageErr ==  ""){
        ...
        if($exist_user_result->num_rows > 0){
            ...
            $sql = "INSERT INTO users (full_name, email, image, password,role)
            VALUES ('$full_name', '$email', '$filename', '$password','admin')";
        ...
        <form class="d-flex justify-content-center" action="registration.php" method="post" enctype="multipart/form-data">
            <div>
                <div class="mb-3">
                    ...
                    <span class="error text-danger"><?php echo $full_nameErr  ?></span>
                </div>
                <div class="mb-3">
                    <div class="mb-3">
